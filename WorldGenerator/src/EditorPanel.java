...
public class EditorPanel extends JPanel {
	...
	private JCheckBox randomColorCheckBox = new JCheckBox("Random colors");
    ...
    private void AssignListeners() 
    {
    	...
    	randomColorCheckBox.removeActionListener(actionListener);
    	randomColorCheckBox.addActionListener(actionListener);
	...
	{	
		...
		public void actionPerformed(ActionEvent e) 
		{
			if("generate".equals(e.getActionCommand())) 
			{
				...
				WorldGeneration.randomColors = randomColorCheckBox.isSelected();
