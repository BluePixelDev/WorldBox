...
public class PerlinNoise 
{
	...
	private static BufferedImage image = new BufferedImage(Main.simulationSize, Main.simulationSize, BufferedImage.TYPE_INT_RGB);
    public static BufferedImage getNoiseImage(){
    	time += 0.01;
    	for(int y = 0; y < Main.simulationSize; y++){
    		for(int x = 0; x < Main.simulationSize; x++){
    			double dx = (double) x / Main.simulationSize;
    			double dy = (double) y / Main.simulationSize;
    			int frequency = 6;
